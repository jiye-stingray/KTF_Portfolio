...
public class StageRankingRewardTab : UITabBase , IRecyclableScrollRectDataSource
{
    ...
    {
        return rankingInfoUI._rankingDungeonList.Count;
    }
    ...
    public void SetCell(ICell cell, int index)
    {
        ...
        item.InitRankingDungeonData(index, rankingInfoUI._rankingDungeonList[index]);
    }
